...
@AutoScan
fun GearyModule.createSetMobAttributesAction() = listener(object : ListenerQuery() {
    val bukkitEntity by get<BukkitEntity>()
    val attributes by source.get<SetMobAttributes>()
}).exec {
    ...
    // Set attributes
    val living: LivingEntity = bukkitEntity as? LivingEntity ?: return@exec
