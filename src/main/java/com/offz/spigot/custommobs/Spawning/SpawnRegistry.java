...
public class SpawnRegistry {
    ...
    static {
        addSpawn("Orth",
                ...
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.OKIBO).setSections("city").setMinAmount(1).setWhitelist(Material.GRASS_BLOCK, Material.STONE_BRICKS).setBasePriority(0.2).build()
        );

        addSpawn("Edge of the Abyss",
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.FUWAGI).setMinLightLevel(7).setMinAmount(2).setMaxAmount(3).setRadius(6).setWhitelist(Material.GRASS_BLOCK).build(),
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.HAMMERBEAK).setBasePriority(0.1).setSpawnPos(MobSpawn.SpawnPosition.AIR).build(),
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.BENIKUCHINAWA).setBasePriority(0.05).setSpawnPos(MobSpawn.SpawnPosition.AIR).build(),
        ...
        addSpawn("Forest of Temptation",
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.ROHANA).setMaxLightLevel(7).setMinAmount(2).setMaxAmount(3).setRadius(6).setWhitelist(Material.GRASS_BLOCK).build(),
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.FUWAGI).setMinLightLevel(7).setMinAmount(2).setMaxAmount(3).setRadius(6).setWhitelist(Material.GRASS_BLOCK).build(),
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.OTTOBAS).setMinAmount(1).setMaxAmount(2).setRadius(10).setWhitelist(Material.GRASS_BLOCK).build(),
                ...
                new MobSpawn.MobSpawnBuilder().setEntityType(CustomType.BENIKUCHINAWA).setBasePriority(0.1).setSpawnPos(MobSpawn.SpawnPosition.AIR).build(),
